...
import numpy as np
from sympy.core import Expr
from algorithm.evolutionary_computing.symbolic_regression.operator_definitions import CONSTANT
...
class AGraph(Encoder):
    ...
    def evaluate_equation_at(self, x):
        ...
        x : MxD array of numeric.
            ...
            dimensions (features)in x and M is the number of data points in x.
